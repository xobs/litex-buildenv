...
ifneq ($(PLATFORM),fomu_evt)
	$(error "Platform should be fomu_evt when using this file!?")
endif
...
gateware-load-$(PLATFORM):
	@echo "fomu_evt doesn't support loading, use the flash target instead."
...
firmware-flash-$(PLATFORM):
	@echo "fomu_evt doesn't support just flashing firmware, use image target instead."
